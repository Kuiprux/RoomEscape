...
public class Button : MonoBehaviour
{
    ...
    int[] blue_button_exact = { 0, 1, 2, 3, 4, 5, 6 }; //8 세그먼트 정답
    int[] blue_button_react = { 3, 1, 0, 6, 5, 4, 4, 4 }; // 반납함 -> 6 {0,1,3,4,5,6}
    int[] red_button_exact = { 1, 2, 3, 4, 6 };   //3
    int[] red_button_react = { 0, 4, 2, 1, 6, 3, 5 }; // 반납함 -> 2 {1,2,4,5,6 }
    int[] yellow_button_exact = { 0, 2, 3, 6 };  //4
    int[] yellow_button_react = { 2, 4, 3, 2, 5, 0, 3 }; // 반납함 -> 1 {2, 3}
    int[] purple_button_exact = { 2, 3 };  //1
    int[] purple_button_react = { 5, 5, 0, 1, 5, 5, 5 }; // 반납함 -> 8 {0,1,3,4,6}
    ...
    bool OnOff(List<bool> button, int n)     //버튼이 켜져있는지 아닌지 
    {
